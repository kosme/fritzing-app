...
FProbeScrollPosition::FProbeScrollPosition(SketchWidget * sketchWidget, const QString& viewSuffix) :
	FProbe(viewSuffix.isEmpty() ? "ScrollPosition" : QString("ScrollPosition_" + viewSuffix).toStdString()),
	m_sketchWidget(sketchWidget) {
	QString probeName = viewSuffix.isEmpty() ? "ScrollPosition" : QString("ScrollPosition_" + viewSuffix);
